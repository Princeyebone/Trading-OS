...
def run_flawless_guarantee_all():
    ...
    # 3. What if on Sept 15 we don't take bad entries after 18:00 or what if lock is $10 or $12?
    for lock_pnl in [10.0, 12.0, 15.0]:
        for max_hour in [18, 19, 20]:
            for sl_ratio in [0.85, 0.95, 1.0]:
                ...
                for i in range(25, n - 20):
                    ...
                    if locked_green or i <= last_exit or not (6 <= cur_hour <= max_hour):
                        continue
                ...
                if green_days == total_days:
                    ...
                    print(f"lock={lock_pnl}, max_hour={max_hour}, sl_ratio={sl_ratio} | Total Net: ${tot_pnl:+.2f}")
